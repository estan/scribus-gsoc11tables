...
PyMethodDef scribus_methods[] = {
	...
	{const_cast<char*>("getCellBackgroundColor"), scribus_getcellbackgroundcolor, METH_VARARGS, tr(scribus_getcellbackgroundcolor__doc__)},
	{const_cast<char*>("getCellLeftBorderWidth"), scribus_getcellleftborderwidth, METH_VARARGS, tr(scribus_getcellleftborderwidth__doc__)},
	{const_cast<char*>("getCellRightBorderWidth"), scribus_getcellrightborderwidth, METH_VARARGS, tr(scribus_getcellrightborderwidth__doc__)},
	{const_cast<char*>("getCellTopBorderWidth"), scribus_getcelltopborderwidth, METH_VARARGS, tr(scribus_getcelltopborderwidth__doc__)},
	{const_cast<char*>("getCellBottomBorderWidth"), scribus_getcellbottomborderwidth, METH_VARARGS, tr(scribus_getcellbottomborderwidth__doc__)},
	{const_cast<char*>("getCellLeftBorderColor"), scribus_getcellleftbordercolor, METH_VARARGS, tr(scribus_getcellleftbordercolor__doc__)},
	{const_cast<char*>("getCellRightBorderColor"), scribus_getcellrightbordercolor, METH_VARARGS, tr(scribus_getcellrightbordercolor__doc__)},
	{const_cast<char*>("getCellTopBorderColor"), scribus_getcelltopbordercolor, METH_VARARGS, tr(scribus_getcelltopbordercolor__doc__)},
	{const_cast<char*>("getCellBottomBorderColor"), scribus_getcellbottombordercolor, METH_VARARGS, tr(scribus_getcellbottombordercolor__doc__)},
	...
	{const_cast<char*>("getTableLeftBorderWidth"), scribus_gettableleftborderwidth, METH_VARARGS, tr(scribus_gettableleftborderwidth__doc__)},
	{const_cast<char*>("getTableRightBorderWidth"), scribus_gettablerightborderwidth, METH_VARARGS, tr(scribus_gettablerightborderwidth__doc__)},
	{const_cast<char*>("getTableTopBorderWidth"), scribus_gettabletopborderwidth, METH_VARARGS, tr(scribus_gettabletopborderwidth__doc__)},
	{const_cast<char*>("getTableBottomBorderWidth"), scribus_gettablebottomborderwidth, METH_VARARGS, tr(scribus_gettablebottomborderwidth__doc__)},
	{const_cast<char*>("getTableLeftBorderColor"), scribus_gettableleftbordercolor, METH_VARARGS, tr(scribus_gettableleftbordercolor__doc__)},
	{const_cast<char*>("getTableRightBorderColor"), scribus_gettablerightbordercolor, METH_VARARGS, tr(scribus_gettablerightbordercolor__doc__)},
	{const_cast<char*>("getTableTopBorderColor"), scribus_gettabletopbordercolor, METH_VARARGS, tr(scribus_gettabletopbordercolor__doc__)},
	{const_cast<char*>("getTableBottomBorderColor"), scribus_gettablebottombordercolor, METH_VARARGS, tr(scribus_gettablebottombordercolor__doc__)},
	{const_cast<char*>("getTableBackgroundColor"), scribus_gettablebackgroundcolor, METH_VARARGS, tr(scribus_gettablebackgroundcolor__doc__)},
	...
	{const_cast<char*>("setCellBackgroundColor"), scribus_setcellbackgroundcolor, METH_VARARGS, tr(scribus_setcellbackgroundcolor__doc__)},
	{const_cast<char*>("setCellLeftBorderWidth"), scribus_setcellleftborderwidth, METH_VARARGS, tr(scribus_setcellleftborderwidth__doc__)},
	{const_cast<char*>("setCellRightBorderWidth"), scribus_setcellrightborderwidth, METH_VARARGS, tr(scribus_setcellrightborderwidth__doc__)},
	{const_cast<char*>("setCellTopBorderWidth"), scribus_setcelltopborderwidth, METH_VARARGS, tr(scribus_setcelltopborderwidth__doc__)},
	{const_cast<char*>("setCellBottomBorderWidth"), scribus_setcellbottomborderwidth, METH_VARARGS, tr(scribus_setcellbottomborderwidth__doc__)},
	{const_cast<char*>("setCellLeftBorderColor"), scribus_setcellleftbordercolor, METH_VARARGS, tr(scribus_setcellleftbordercolor__doc__)},
	{const_cast<char*>("setCellRightBorderColor"), scribus_setcellrightbordercolor, METH_VARARGS, tr(scribus_setcellrightbordercolor__doc__)},
	{const_cast<char*>("setCellTopBorderColor"), scribus_setcelltopbordercolor, METH_VARARGS, tr(scribus_setcelltopbordercolor__doc__)},
	{const_cast<char*>("setCellBottomBorderColor"), scribus_setcellbottombordercolor, METH_VARARGS, tr(scribus_setcellbottombordercolor__doc__)},
	...
	{const_cast<char*>("setTableColumnWidth"), scribus_settablecolumnwidth, METH_VARARGS, tr(scribus_settablecolumnwidth__doc__)},
	{const_cast<char*>("setTableRowHeight"), scribus_settablerowheight, METH_VARARGS, tr(scribus_settablerowheight__doc__)},
	{const_cast<char*>("setTableStyle"), scribus_settablestyle, METH_VARARGS, tr(scribus_settablestyle__doc__)},
	{const_cast<char*>("setTableLeftBorderWidth"), scribus_settableleftborderwidth, METH_VARARGS, tr(scribus_settableleftborderwidth__doc__)},
	{const_cast<char*>("setTableRightBorderWidth"), scribus_settablerightborderwidth, METH_VARARGS, tr(scribus_settablerightborderwidth__doc__)},
	{const_cast<char*>("setTableTopBorderWidth"), scribus_settabletopborderwidth, METH_VARARGS, tr(scribus_settabletopborderwidth__doc__)},
	{const_cast<char*>("setTableBottomBorderWidth"), scribus_settablebottomborderwidth, METH_VARARGS, tr(scribus_settablebottomborderwidth__doc__)},
	{const_cast<char*>("setTableLeftBorderColor"), scribus_settableleftbordercolor, METH_VARARGS, tr(scribus_settableleftbordercolor__doc__)},
	{const_cast<char*>("setTableRightBorderColor"), scribus_settablerightbordercolor, METH_VARARGS, tr(scribus_settablerightbordercolor__doc__)},
